...
df          = quandl.get_table('WIKI/PRICES', date = { 'gte': '1990-01-01', 'lte': '2017-08-01' }, ticker = 'EBAY')
df_original = quandl.get_table('WIKI/PRICES', date = { 'gte': '1990-01-01', 'lte': '2017-08-01' }, ticker = 'EBAY')
...
df_original.fillna(REPLACE_NA, inplace = True)
...
# extract the last few elements in X to create a prediction
# generate testing data from the original data
...
# train the linear regiression model
...
# assign prediction label for the future dates
